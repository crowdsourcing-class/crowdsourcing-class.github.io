...
7. There are several tools for better Turking (e.g. [Turkopticon](http://turkopticon.differenceengines.com/) and [TurkerNation](http://turkernation.com/)). Please explore a few of these and give us your thoughts. 
8. Provide short answers (a few sentences each) to the following questions:
