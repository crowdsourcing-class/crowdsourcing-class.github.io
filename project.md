...
The final term project will be a self-designed project created by the students in consultation with the professor and the TA.  The project will be done in 4 parts beginning mid-semester.  Each of these will have an associated set of deliverables.  Together these parts will be worth 40% of your overall grade.   The project must be done in teams.  The minimum team size is 3, and the maximum size is 5.   All team members will receive the same grade on the project.
...
* [Part 1: Form a team and brainstorm 3 ideas](final-project-part1.html) -- This is worth 5% of your overall grade.
...
* [Part 4: Analyze your results and produce a video about your project](final-project-part4.html) -- This is worth 15% of your overall grade.


### $10,000 Prize

This year I am awarding a $10,000 Prize to the project that I like the most.  Does that mean that I will give you $10,000?  No. Here's what it means: I am willing to invest $10,000 of my research money into developing something more robust.  So, if I decided that Shoptimum were the best project from last year, then I would put the money towards development time with [a software development company that I work with](http://10clouds.com), with the hopes of launching it as an actual company.  If CriticCritic were the best project, then the budget would go towards a much larger scale annotation effort on CrowdFlower or Mechanical Turk, so that we could analyze media coverage of all 50 senators instead of just half a dozen people, for instance.  For a research-oriented effort like that, instead of launching a company, I will write an academic paper about it.

The goal of this investment is a chance for you to polish the projects in this class, either to launch your own startup company (with me as a member of the board of directors) or to get a research publication out of it (with me as a co-author).  I figure that $10,000 is a drop in the bucket compared to other research efforts that I invest in.  I hope that this prize will be a fun way of incentivizing you to excellent work that you find exciting and are proud of.
