...
You can download the mostly clean data [here](assignments/downloads/aggregated_data.json). It contains 8,800 reports and the structured data that our Turkers extracted. The data is in [JSON](http://en.wikipedia.org/wiki/JSON) format, which is easy to load in python like so:
