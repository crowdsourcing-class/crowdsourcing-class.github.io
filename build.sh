...
./Markdown_1.0.1/Markdown.pl readings/intro.md | perl Markdown_1.0.1/wrap.pl > readings/intro.html 
./Markdown_1.0.1/Markdown.pl readings/platform.md | perl Markdown_1.0.1/wrap.pl > readings/platform.html 
./Markdown_1.0.1/Markdown.pl readings/programming.md | perl Markdown_1.0.1/wrap.pl > readings/programming.html 
./Markdown_1.0.1/Markdown.pl readings/hci.md | perl Markdown_1.0.1/wrap.pl > readings/hci.html 
./Markdown_1.0.1/Markdown.pl readings/ml.md | perl Markdown_1.0.1/wrap.pl > readings/ml.html 
./Markdown_1.0.1/Markdown.pl readings/econ.md | perl Markdown_1.0.1/wrap.pl > readings/econ.html 
./Markdown_1.0.1/Markdown.pl readings/social-science.md | perl Markdown_1.0.1/wrap.pl > readings/social-science.html 
./Markdown_1.0.1/Markdown.pl readings/collective-intelligence.md | perl Markdown_1.0.1/wrap.pl > readings/collective-intelligence.html 
